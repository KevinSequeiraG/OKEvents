...
const Navbar = ({ children }) => {
    ...
    return (
        <>
            ...
            {isLoginPage || isPreLoginPage || isRegisterPage || isVerifyEmail || isActiveUsers || isEditRegistration ?
                ...
                <div className="h-screen w-full relative overflow-hidden font-Inter flex flex-col lg:flex-row">
                    ...
                    <div className="block md:hidden z-[51]">
                        ...
                        {showNavbar && <div className="absolute top-[3.6rem]">
                            <Link href={"/myAccount"} onClick={() => { setShowNavbar(false) }}>
                        ...
                        <nav
                            ...
                            <div className="h-14 w-5 fill-[#899592] flex items-center justify-center rounded-[19px] cursor-pointer lg:mr-auto px-1 w-auto min-w-[2.5rem] profileElement ml-3">
                                ...
                                <div className="w-full test">
                                    ...
                                    >
                                        <p className="px-2 text-[9px] text-black">
                                            Registrador
                                        </p>
                                    </div>
                                </div>
