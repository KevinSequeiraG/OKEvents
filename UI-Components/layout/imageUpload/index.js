  ...
  return (
    <div className="flex justify-center items-center w-full relative h-min">
      <label className={containerClassName}>
        <div
          className={`flex justify-center items-center w-full h-full bg-white rounded-xl cursor-pointer`}
        >
          {profilePicture ? (
            <>
            ...
            <>
              {fileLoadingAnimation ? (
                ...
                <>
                  ...
                  <div className="absolute flex justify-center items-center  left-0 h-24 w-full rounded-[10px] opacity-0 hover:opacity-100 !bg-[#707070] !bg-opacity-60 transition delay-75 duration-300">
                    <div className="flex flex-col items-center justify-center ">
                      <svg
                ...
                <div className="flex justify-center items-center border-[#8B9592]">
                  <svg
                    xmlns={"http://www.w3.org/2000/svg"}
                    className="ml-3"
                    width="20.75"
